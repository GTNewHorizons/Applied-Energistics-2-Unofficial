...
public final class ApiMaterials implements IMaterials {
    ...
    private final IItemDefinition cardRegulator;
    ...
    public ApiMaterials(final DefinitionConstructor constructor) {
        ...
        this.cardRegulator = new DamagedItemDefinition(itemMultiMaterial.createMaterial(MaterialType.CardRegulator));
    ...
    @Override
    public IItemDefinition cardRegulator() {
        return this.cardRegulator;
    }
}
