...
public enum GuiText implements Localization {
    ...
    ReshuffleScanDuplicatePartitionLoc,
    ReshuffleScanDuplicatePartitionLocColor,
    ReshuffleScanDuplicatePartitionLocValueColor,
    ReshuffleScanDuplicatePartitionLocDim,
