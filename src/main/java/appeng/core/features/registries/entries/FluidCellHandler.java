...
// import ae2fc.common.item.ItemBasicFluidStorageCell;

public class FluidCellHandler implements ICellHandler {

    @Override
    public boolean isCell(final ItemStack is) {
        return is != null && is.getItem().toString().contains("FluidStorageCell");
    }
    ...
    public IIcon getTopTexture_Light() {
        return ExtraBlockTextures.BlockMEChestFluids_Light.getIcon();
    }

    @Override
    public IIcon getTopTexture_Medium() {
        return ExtraBlockTextures.BlockMEChestFluids_Medium.getIcon();
    }

    @Override
    public IIcon getTopTexture_Dark() {
        return ExtraBlockTextures.BlockMEChestFluids_Dark.getIcon();
    }
