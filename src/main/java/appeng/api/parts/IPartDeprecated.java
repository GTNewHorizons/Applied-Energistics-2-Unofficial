 ...
 * Methods can return null to indicate that the part should be removed entirely.
 */
public interface IPartDeprecated {

    /**
     * transformPart - takes the "def:" tag and transforms it. The returned tag may be a copy of the tag passed in,
     * or it could be transformed in-place.
    ...
    /**
     * transformNBT - takes the "extra:" tag transforms it. The returned tag may be a copy of the tag passed in,
     * or it could be transformed in-place.
