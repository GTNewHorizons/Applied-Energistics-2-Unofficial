...
public class GuiCraftingCPURefactored extends AEBaseGui implements ISortSource, IGuiTooltipHandler {
    ...
    private final ContainerCraftingCPURefactored container;
    ...
    public GuiCraftingCPURefactored(final InventoryPlayer inventoryPlayer, final Object target) {
        this(new ContainerCraftingCPURefactored(inventoryPlayer, target));
    }

    protected GuiCraftingCPURefactored(final ContainerCraftingCPURefactored container) {
        super(container);
