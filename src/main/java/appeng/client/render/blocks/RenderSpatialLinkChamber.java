...
public class RenderSpatialLinkChamber extends BaseBlockRender<BlockSpatialLinkChamber, TileSpatialLinkChamber> {
    ...
    @Override
    public boolean renderInWorld(BlockSpatialLinkChamber block, IBlockAccess world, int x,
        ...
        if (ti != null && ti.hasBoundStorage()) {
            info.setTemporaryRenderIcons(null, null, ExtraBlockTextures.BlockSpatialLinkChamberFrontFull.getIcon(), null, null, null);
        }
