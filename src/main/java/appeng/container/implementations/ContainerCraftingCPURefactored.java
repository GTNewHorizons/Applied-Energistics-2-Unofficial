...
public class ContainerCraftingCPURefactored extends AEBaseContainer
    ...
    public ContainerCraftingCPURefactored(final InventoryPlayer inventoryPlayer, final Object target) {
